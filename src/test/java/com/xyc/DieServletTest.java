...
class DieServletTest {

    @Test
    public void checkStayTest() throws IOException {
        ...
        try (WebClient webClient = new WebClient()) {
            ...
            for (int i = 0; i < fieldset.size(); i++) {
                ...
                if (htmlRadioButtonInput.getId().equals("void")) {
                    ...
                    HtmlElement desc_die = pageAfterClickWithNextAndVoid.getHtmlElementById("desc_die");
                    assertEquals("\n" +
                            "            END\n" +
                    ...
                    assertEquals("http://localhost:8080/startNewDie?form_button=", url.toString());
